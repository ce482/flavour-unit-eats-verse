          ...
          <div className="container-wide">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Looking for quick answers? Check out our FAQs or contact us for more information.
              </p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="text-xl font-bold mb-3">Do you ship nationwide?</h3>
                <p className="text-gray-600">
                  Yes, we ship to all states within the continental United States. Standard shipping is 2-day delivery via FedEx to ensure products arrive frozen.
                </p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="text-xl font-bold mb-3">How do I prepare your products?</h3>
                <p className="text-gray-600">
                  Our products can be prepared in an air fryer, conventional oven, or deep fryer. Specific instructions are included on each package.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600">
                  Yes, we offer wholesale pricing for grocery stores, restaurants, catering companies, and other food service businesses.
                </p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="text-xl font-bold mb-3">How can I book a consultation?</h3>
                <p className="text-gray-600">
                  You can book a consultation with Legacy Kitchen Solutions through our website or by contacting us directly.
                </p>
              </div>
            </div>
            
            <div className="text-center mt-8">
              <a href="/faq" className="text-flavour-red font-medium hover:underline inline-flex items-center">
                View All FAQs
